...
import com.app.cbonelo.mobile.AgentBatchesReceived.AgentBatchesReceived;
import com.app.cbonelo.mobile.AgentBatchesReceived.AgentNormalBatchesReceivedList;
...
public class AgentReceiveBatchesTab extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            tabHost.getTabWidget().getChildAt(0).setBackgroundColor(Color.parseColor("#6b210a")); // unselected
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                for (int i = 0; i < tabHost.getTabWidget().getChildCount(); i++) {
                    ...
                    tabHost.getTabWidget().getChildAt(i).setBackgroundColor(getResources().getColor(R.color.greenontrack)); // unselected
                    tv.setTextColor(Color.parseColor("#FFFD6E"));
                }

                tabHost.getTabWidget().getChildAt(tabHost.getCurrentTab()).setBackgroundColor(Color.parseColor("#6b210a")); // selected
