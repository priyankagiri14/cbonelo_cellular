...
public class CreatedUsersAdapter extends RecyclerView.Adapter<UsersViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(com.app.cbonelo.mobile.Driver.DriverAttendance.model.get_Agent.Body item);
    }

    private List<FetchAgent> batchesGetLists;
    private List<com.app.cbonelo.mobile.Driver.DriverAttendance.model.get_Agent.Body> bodyList;
