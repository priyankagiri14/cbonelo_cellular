...
public class CreatedUsersList extends AppCompatActivity implements UsersViewHolder.OnItemListener, NetworkStateReceiver.NetworkStateReceiverListener {
    ...
    private int imageid;
    List<com.app.cbonelo.mobile.Driver.DriverAttendance.model.get_Agent.Body> list1;
    List<com.app.cbonelo.mobile.Driver.DriverAttendance.model.get_Agent.Body> agent = new ArrayList<>();
    TextView noagents;
