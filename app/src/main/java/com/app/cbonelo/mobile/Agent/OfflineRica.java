package com.app.cbonelo.mobile.Agent;
...
import com.app.cbonelo.mobile.OpenCloseBatches.CashHistory.AppDatabaseSerials;
import com.app.cbonelo.mobile.OpenCloseBatches.CashHistory.Serials;
import com.app.cbonelo.mobile.OpenCloseBatches.CashHistory.SerialsAdapter;
import com.app.cbonelo.mobile.OpenCloseBatches.CashHistory.SerialsInterface;
        ...
        if (v.getId() == R.id.activate_sim) {
            ...
            if(idspinner.getSelectedItem().toString().equals("ID")) {
                if (fname.getText().toString().length() == 0 || lname.getText().length() == 0 || address.length() == 0 ||
                        ...
                        || regionspinner.getSelectedItemPosition() == 0 || searchView.getQuery().length() == 0 || idnum.getText().length() == 0 || idspinner.getSelectedItem().toString() .equals( "ID Type")) {
                    Toast.makeText(this, "Enter required fields", Toast.LENGTH_SHORT).show();
                } else {
                    simallocation(searchView.getQuery().toString(), network, idnum.getText().toString(), fname.getText().toString(), lname.getText().toString(),
                ...
                if (fname.getText().toString().length() == 0 || lname.getText().length() == 0 || address.length() == 0 ||
                        pincode.getText().toString().length() == 0 || subhurb.getText().toString().length() == 0 || TextUtils.isEmpty(network)
                        || regionspinner.getSelectedItemPosition() == 0 || searchView.getQuery().length() == 0 || passport.getText().length() == 0 || expirydate.getText().length() == 0 || idspinner.getSelectedItem().toString() .equals( "ID Type")) {
                    Toast.makeText(this, "Enter required fields", Toast.LENGTH_SHORT).show();
                } else {
