...
import com.app.cbonelo.mobile.SharedPreference.SharedPref;
import com.app.cbonelo.mobile.Web_Services.MyApp;
import com.app.cbonelo.mobile.Web_Services.RetrofitClient;
...
public class Navigation_Main extends AppCompatActivity
     ...
     * the authority type value condition.
     */
    private void agentLoginCheck() {
        Log.d("navigation_main", "agentLoginCheck: sending request to server ");
        ...
        credentailsCheckResponseCall.enqueue(new Callback<CredentailsCheckResponse>() {
            ...
            public void onFailure(Call<CredentailsCheckResponse> call, Throwable t) {
                Log.d("navigation_main", "onFailure: "+t.getLocalizedMessage());
