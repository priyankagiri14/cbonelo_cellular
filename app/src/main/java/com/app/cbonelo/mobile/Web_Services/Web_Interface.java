package com.app.cbonelo.mobile.Web_Services;

import com.app.cbonelo.mobile.Agent.AttendanceGetResponse.AttendanceConfirmResponse;
import com.app.cbonelo.mobile.Agent.AttendanceGetResponse.AttendanceGetResponse;
import com.app.cbonelo.mobile.Agent.ScanBatchesResponse;
import com.app.cbonelo.mobile.Agent.ScanPojo;
import com.app.cbonelo.mobile.Agent.model.Simallocatemodel;
import com.app.cbonelo.mobile.AgentBatchesGet.AgentBatchesGetResponse;
import com.app.cbonelo.mobile.AgentBatchesGet.MyPojo;
import com.app.cbonelo.mobile.AgentBatchesReceived.AgentBatchesReceivedResponse;
import com.app.cbonelo.mobile.Agent_Login.AgentLoginResponse;
import com.app.cbonelo.mobile.Agent_Login.RefreshToken;
import com.app.cbonelo.mobile.AgentsGetResponse.AgentsGetResponse;
import com.app.cbonelo.mobile.AgentsList.AgentsListResponse;
import com.app.cbonelo.mobile.AirtimeSales.model.SmartCallAgentLogin;
import com.app.cbonelo.mobile.AirtimeSales.model.get_all_networks.GetAllNetworksResponse;
import com.app.cbonelo.mobile.AirtimeSales.model.get_data_plans.GetAllDataPlansResponse;
import com.app.cbonelo.mobile.AllocationCreateResponse.AllocationCreate;

import com.app.cbonelo.mobile.AllocationGet.AllocationGetResponse;
import com.app.cbonelo.mobile.AllocationStatus.AgentAllocationStatusResponse;
import com.app.cbonelo.mobile.AllocationStatus.AllocationStatusResponse;
import com.app.cbonelo.mobile.AnyAgentAllocation.AgentSearchResponse;
import com.app.cbonelo.mobile.Driver.Contract.ContractResponse;
import com.app.cbonelo.mobile.Driver.DriverAttendance.model.driverattendancephoto.IndividualAttendancePojo;
import com.app.cbonelo.mobile.Driver.DriverAttendance.model.team_attendance.TeamAttendanceResponse_MyPojo;
import com.app.cbonelo.mobile.Driver.DriverAttendance.model.team_attendance.Team_Attendance_Response;
import com.app.cbonelo.mobile.Driver.DriverSubAgentRegister.model.SubAgentResponseModel;
import com.app.cbonelo.mobile.Driver.SignUpAgent.ResponseAuthority;
import com.app.cbonelo.mobile.Driver.Driver_Dashboard.ValueWalletResponse;
import com.app.cbonelo.mobile.Driver.SignUpAgent.SignUpResponse;
import com.app.cbonelo.mobile.Driver.SignUpAgent.UpdateResponse;
import com.app.cbonelo.mobile.Driver.SignUpAgent.WarehouseResponse;
import com.app.cbonelo.mobile.DriverBatchesGet.BatchesGetResponse;
import com.app.cbonelo.mobile.DriverBatchesGet.Pojo;
import com.app.cbonelo.mobile.BatchesReceived.BatchesReceivedResponse;
import com.app.cbonelo.mobile.CredentialsCheck.CredentailsCheckResponse;
import com.app.cbonelo.mobile.Driver.DriverAttendance.model.driverattendancephoto.IndividualAttendanceResponse;
import com.app.cbonelo.mobile.Driver.DriverAttendance.model.driverattendancephoto.UploadedFile;
import com.app.cbonelo.mobile.Driver.DriverAttendance.model.get_Agent.FetchAgent;
import com.app.cbonelo.mobile.FetchOneAgent.CommentsResponse;
import com.app.cbonelo.mobile.FetchOneAgent.FetchOneAgent;
import com.app.cbonelo.mobile.OpenBatchesResponse.OpenedBatchesResponse;
import com.app.cbonelo.mobile.OpenBatchesResponse.SerialsGet;
import com.app.cbonelo.mobile.OpenCloseBatches.CashHistory.CashHistoryResponse;
import com.app.cbonelo.mobile.OpenCloseBatches.OpenCloseResponse;
import com.app.cbonelo.mobile.OpenCloseBatches.SerialsGetResponse;
